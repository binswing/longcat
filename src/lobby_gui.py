...
class lobby_gui_class(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.edit_button['font'] = tkfont.Font(family="Helvetica",size=45,weight="bold")
        self.play_button['font'] = tkfont.Font(family="Helvetica",size=45,weight="bold")
        self.edit_button.grid(row = 0, column = 0, sticky = "nsew" ,pady = 60,padx=150)
        self.play_button.grid(row = 1, column = 0, sticky = "nsew" ,pady = 60,padx=150)      